...
class GerenciamentoTesteCasoUsoHomologacaoController extends Base_Controller_Action
{
	...
	public function gridGerenciamentoTesteCasoUsoHomologacaoAction()
	{
        ...
        $this->view->res = $this->itemTesteRegraNegocio->getGridItemTesteCasoDeUsoAll('homologacao',$cd_caso_de_uso,$cd_projeto,$cd_modulo);
    }
    ...
    public function saveAction()
    {
        ...
        foreach( $homologacoes as $codigoItemTeste => $textArea ){
            if( $retorno ){
                ...
                if(!empty($textArea)){
                    $arr['st_item_teste_caso_de_uso'] = "F";
    ...
    public function notApproveAction()
    {
        ...
        foreach( $homologacoes as $codigoItemTeste => $textArea ){
            if( $retorno ){
                ...
                $arr = array();
                $arr['tx_homologacao']                  = $textArea;
                $arr['st_item_teste_caso_de_uso']       = null;
                if(!empty($textArea)){
                    $arr['dt_homologacao']              = null;
                    $arr['st_homologacao']              = null;
                    $arr['cd_profissional_homologacao'] = null;
