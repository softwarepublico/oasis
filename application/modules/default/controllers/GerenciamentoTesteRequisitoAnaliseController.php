...
class GerenciamentoTesteRequisitoAnaliseController extends Base_Controller_Action
{
	...
	public function gridGerenciamentoTesteRequisitoAnaliseAction()
	{
        ...
        $this->view->res = $this->itemTesteRequisito->getGridItemTesteRequisitoAll('analise',$cd_requisito,$cd_projeto);
    }
