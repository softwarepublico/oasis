...
class AcompanhamentoFiscalizacaoDocumentacaoController extends Base_Controller_Action
{
    private $objDocumentacaoProjeto;
    private $tipoDocumentacao;
    private $objProjetos;
    private $_pathDocProjetoAcompanhamento;

    public function init()
    {
        parent::init();
        $this->_pathDocProjetoAcompanhamento = DIRECTORY_SEPARATOR . "public"
    ...
    public function indexAction()
    {
   	...
   	public function gridDocumentacaoAcompanhamentoAction()
	{
		...
		$this->view->res = $this->objDocumentacaoProjeto->getDadosDocumentacaoProjetoAcompanhamento($cd_projeto);
	}
    ...
    public function uploadFileAction()
	{
        ...
        try{
            ...
            if( $uploadValid ){
                ...
                . $this->_pathDocProjetoAcompanhamento;
                ...
                chdir($caminho . $dirProjeto ); //aponta para o diretorio do projeto
                
                $dirProjetoAcompanhamento = DIRECTORY_SEPARATOR . 'acompanhamento';
                if (!file_exists($caminho . $dirProjeto . $dirProjetoAcompanhamento))
                    mkdir('acompanhamento');
                
                chdir($caminho . $dirProjeto . $dirProjetoAcompanhamento ); //aponta para o diretorio de acompanhamento

                $returnUpload = move_uploaded_file($_FILES[$fileElementName]['tmp_name'],
                                $caminho
                                . $dirProjeto
                                . $dirProjetoAcompanhamento
                                . DIRECTORY_SEPARATOR
                                . $novoNome);
                if (!$returnUpload){
	...
	public function downloadAction()
	{
        ...
        $arquivo = SYSTEM_PATH_ABSOLUTE
        		  ...
        		  .DIRECTORY_SEPARATOR."acompanhamento"
