...
class GerenciamentoTesteRegraNegocioSolucaoController extends Base_Controller_Action
{
	...
	public function gridGerenciamentoTesteRegraNegocioSolucaoAction()
	{
        ...
        $this->view->res = $this->itemTesteRegraNegocio->getGridItemTesteRegraNegocioAll('solucao',$cd_regra_negocio,$cd_projeto);
	}
