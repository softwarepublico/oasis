...
class GerenciamentoTesteRegraNegocioHomologacaoController extends Base_Controller_Action
{
    ...
    public function gridGerenciamentoTesteRegraNegocioHomologacaoAction()
    {
        ...
        $this->view->res = $this->itemTesteRegraNegocio->getGridItemTesteRegraNegocioAll('homologacao',$cd_regra_negocio,$cd_projeto);
    }
    ...
    public function saveAction()
    {
        ...
        foreach( $homologacoes as $codigoItemTeste => $textArea ){
            if( $retorno ){
                ...
                if(!empty($textArea)){
                    $arr['st_item_teste_regra_negocio'] = "F";
    ...
    public function notApproveAction()
    {
        ...
        foreach( $homologacoes as $codigoItemTeste => $textArea ){
            if( $retorno ){
                ...
                $arr = array();
                $arr['tx_homologacao']                  = $textArea;
                $arr['st_item_teste_regra_negocio']     = null;
                if(!empty($textArea)){
                    $arr['dt_homologacao']              = null;
                    $arr['st_homologacao']              = null;
                    $arr['cd_profissional_homologacao'] = null;
