...
class Solicitacao extends Base_Db_Table_Abstract
{
	...
	public function getSolicitacao($cd_objeto, $ni_solicitacao, $ni_ano_solicitacao)
	{
        ...
        $select->from(array('sol'=>$this->_name),
                      array('*',
                          'st_solicitacao'=> new Zend_Db_Expr("CASE st_solicitacao
                                                                        ...
                                                                        WHEN '6' THEN '".Base_Util::getTranslator('L_SQL_SERVICE_DESK')."'
...
*/
	...
	public function getSolicitacaoGerenteProposta($cd_objeto, $mes, $ano)
	{
...
//		return $this->getAdapter()->fetchAll($sql);
	...
	public function getSolicitacaoTipoDemanda($mes, $ano, $cd_objeto, $cd_profissional=null, $isObject=false)
	{
		//*** Seleciona as solicitações de serviço
...
//		return $this->getAdapter()->fetchAll($sql);
	...
	public function getSolicitacaoTipoDemandaExecutada($mes, $ano, $cd_objeto, $cd_profissional=null, $isObject=false)
	{
		/**
...
//		return $this->getAdapter()->fetchAll($sql);
	...
	public function getSolicitacaoTipoDemandaConcluida($mes, $ano, $cd_objeto, $cd_profissional=null, $isObject=false)
	{
		//*** Seleciona as solicitações de serviço
		//enviadas para os gerentes de projeto do tipo DEMANDA
...
//		return $this->getAdapter()->fetchAll($sql);
	...
	public function getSolicitacaoCoordenacao($mes, $ano, $cd_objeto = null, $st_solicitacao = null)
	{
...
*/
	...
	public function atualizaSolicitacao($cd_objeto, $ni_solicitacao, $ni_ano_solicitacao, $arrUpdate)
	{
		$erros = false;
   ...
   /**
     ...
     */
    public function criaNovaSolicitacaoServico(Array $arrInsert=array())
    {
     ...
     */
	public function getQtdSolicitacoes($cd_objeto, $st_status_solicitacao, $ni_ano_solicitacao)
	{
        $select = $this->select()
     ...
     * @return Array
     */
	public function getSolicitacaoTipoDemandaConsulta($cd_objeto, $cd_unidade = null, $tx_solicitante = null, $dt_inicio = null, $dt_fim = null, $cd_profissional = null, $tx_demanda = null, $tipo_consulta = 'and', $ni_solicitacao = null, $ni_ano_solicitacao = null)
	{
        $select = $this->select()
                       ->setIntegrityCheck(false)
                       ->distinct();
...
*/
     ...
     * @return Array
     */
	public function getSolicitacaoServicoConsulta($cd_objeto, $cd_unidade = null, $ni_solicitacao = null, $ni_ano_solicitacao = null, $tx_solicitante = null, $dt_inicio = null, $dt_fim = null, $tx_solicitacao = null, $tipo_consulta)
	{
        $select = $this->select()
                       ->setIntegrityCheck(false)
                       ->distinct();
...
*/
	 ...
	 */
	public function buscaDadosJustificativaSolicitacao($arrHoras,$dt_solicitacao,$ni_minutos_justificativa,$dataHoraAgora,$dataAgora)
	{
