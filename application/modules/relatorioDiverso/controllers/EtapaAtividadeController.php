...
class RelatorioDiverso_EtapaAtividadeController extends Base_Controller_Action
{
	...
	public function indexAction()
	{
		...
		$this->view->comboObjeto = $this->objObjetoContrato->getObjetoContratoAtivo( null, true, false, true );
	}
	
	public function etapaAtividadeAction()
	{
		$this->_helper->viewRenderer->setNoRender(true);
		$this->_helper->layout->disableLayout();
		
		$this->cd_objeto = $this->_request->getParam("cd_objeto");
		
		$this->arrEtapa     = $this->objEtapa->getEtapa( $this->cd_objeto );
	...
	private function geraRelatorio()
	{
        ...
        $this->objPdf->iniciaRelatorio(Base_Util::getTranslator('L_TIT_REL_ETAPA_ATIVIDADE'), $arrKeywords);
