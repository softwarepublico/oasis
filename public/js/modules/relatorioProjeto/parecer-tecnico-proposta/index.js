...
$(document).ready(  function() {
    ...
    $('#btn_gerar').click( function(){
        ...
        gerarRelatorio( $('#formRelatorioParecerProposta') , 'parecer-tecnico-proposta/generate' );
        return true;
    });
});
...
function getProjeto()
{
	$.ajax({
		type: "POST",
		url: systemName+"/"+systemNameModule+"/parecer-tecnico-proposta/pesquisa-projeto",
