...
$(document).ready(  function() {
    ...
    $('#btn_gerar').click( function(){
        ...
        gerarRelatorio( $('#formRelatorioProjetoParecerTecnicoParcela') , 'parecer-tecnico-parcela/generate' );
        return true;
    });
});
...
function getProjeto()
{
	$.ajax({
		type: "POST",
		url: systemName+"/"+systemNameModule+"/parecer-tecnico-parcela/pesquisa-projeto",
