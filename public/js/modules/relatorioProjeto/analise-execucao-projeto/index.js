...
$(document).ready(  function() {
	...
	$('#btn_gerar').click( function(){
        ...
        gerarRelatorio( $('#formRelatorioAnaliseExecucaoProjeto') , 'analise-execucao-projeto/analise-execucao-projeto' );
        return true;
    });
});
...
function getProjeto()
{
	$.ajax({
		type: "POST",
		url: systemName+"/"+systemNameModule+"/analise-execucao-projeto/pesquisa-projeto",
